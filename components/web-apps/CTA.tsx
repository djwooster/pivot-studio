    ...
    <section className="bg-[#0a0a0a] noise py-32 px-6">
      <div className="max-w-[90rem] mx-auto" ref={ref}>
        ...
        >
          ...
          >
            Let&apos;s build the tool your team actually needs.
          </h2>

          <p className="text-base text-white/50 max-w-md leading-relaxed md:text-center">
            Book a free 30-minute call. We&apos;ll dig into your workflow, identify exactly where a custom app would make the biggest difference, and map out how we&apos;d build it.
          </p>
