...
export default function WhoWeWorkWith() {
  ...
  return (
    <section className="bg-[#0d0d0d] py-28 px-6" id="who-we-work-with">
          ...
          >
            {businessTypes.map((type) => (
              <motion.span
                ...
                className="inline-flex items-center h-9 px-4 rounded-full border border-white/15 text-sm text-white/65 font-medium hover:border-white/35 hover:text-white/85 transition-colors duration-200 cursor-default"
              >
                {type}
              </motion.span>
            ))}
